  ...
  <el-card class="cards" :class="tableParams.full ? 'fullScreen' : ''">
    ...
    <el-row :gutter="0" style="margin-bottom:10px">
      ...
      >
        ...
        >
          <el-form-item label="交易对方卡号:" prop="partAccNo">
            <el-input
              v-model="queryForm.partAccNo"
              placeholder="请输入交易对方卡号"
              clearable
              :style="{ width: '100%' }"
            >
            </el-input>
...
import { midTransPrepaidCard } from '@/assets/selectoptions/midTrans/prepaidCard'
export default {
  components: {
    TableSetting
  },
  data() {
    return {
      ...
      // 资金收付标识
      lendFlagOptions: midTransPrepaidCard.lendFlagOptions
    }
  },
  created() {
    this.bizQuery()
