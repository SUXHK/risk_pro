          ...
          >
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item
                ...
                @click.native="editDialog(scope.row, 'newSubDep')"
                >新建下级部门</el-dropdown-item
              >
              <el-dropdown-item
                icon="el-icon-plus"
                @click.native="editDialog(scope.row, 'newLevelDep')"
              ...
              <el-dropdown-item
                divided
                icon="el-icon-remove"
                @click.native="editDialog(scope.row, 'disable')"
                >停用</el-dropdown-item
              >
              <el-dropdown-item
                icon="el-icon-delete-solid"
                @click.native="editDialog(scope.row, 'del')"
                >删除</el-dropdown-item
              >
            </el-dropdown-menu>
          </el-dropdown>
...
import Dialog from './dept/dialog.vue'
export default {
  components: {
    Dialog
  },
  ...
  methods: {
    ...
    editDialog(row, name) {
      if (name === 'edit') {
        ...
        this.$message.success(row.id + name)
        // 删除
      } else if (name === 'del') {
        this.$message.success(row.id + name)
      } else {
