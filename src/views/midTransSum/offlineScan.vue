...
import { midTransSumOfflineScan } from '@/assets/selectoptions/midTransSum/offlineScan'
export default {
  components: {
    TableSetting
  },
  data() {
    return {
      ...
      // 交易币种
      transCurrcyCodeOptions: midTransSumOfflineScan.transCurrcyCodeOptions
    }
  },
  created() {
    this.bizQuery()
