  ...
  <el-card class="cards" :class="tableParams.full ? 'fullScreen' : ''">
    ...
    <el-row :gutter="0" style="margin-bottom:10px">
      ...
      >
        ...
        >
          <el-form-item label="发卡机构商户编码:" prop="joinCode">
            <el-input
              v-model="queryForm.joinCode"
              placeholder="请输入发卡机构商户编码"
              clearable
              :style="{ width: '90%' }"
            >
            </el-input>
        ...
        >
          <el-form-item label="受理机构商户编码:" prop="joinCode1">
            <el-input
              v-model="queryForm.joinCode1"
              placeholder="请输入受理机构商户编码"
              clearable
              :style="{ width: '90%' }"
            >
            </el-input>
...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: {},
      queryForm: {
        joinCode: '', // 发卡机构商户编码 字符型 50
        joinCode1: '', // 受理机构商户编码 字符型 50
